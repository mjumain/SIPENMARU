                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                                <b>Nomor Tagihan: {{ $cek_pembayaran_pendaftaran->nomor_pembayaran }}</b><br />
                                <br />
                                <b>Tanggal Berlaku:</b> {{ $cek_pembayaran_pendaftaran->waktu_berlaku }}<br />
                                <b>Tanggal Kadaluarsa:</b> {{ $cek_pembayaran_pendaftaran->waktu_kadaluarsa }}
                            </div>
                        </div>
